...
const translations = {
  ja: {
    ...
    backButton: '← 戻る',
    aboutTitle: 'About PomoTODO',
    aboutApp: '📝 アプリについて',
    aboutDescription: 'PomoTODOは、ポモドーロテクニックを活用したTODO管理アプリです。タスクごとにポモドーロタイマーを設定し、効率的に作業を進めることができます。',
    aboutAuthor: '👤 作者',
  ...
  en: {
    ...
    aboutDescription: 'PomoTODO is a TODO management app that integrates the Pomodoro Technique. Set pomodoro timers for each task and work efficiently.',
    aboutAuthor: '👤 Author',
...
function App() {
  ...
  return (
    <div className={`app ${showCelebration ? 'celebration-mode' : ''}`}>
      ...
      <div className="container">
        <h1 className="title">{translations[language].appName}</h1>
                ...
                <div className="timer-section">
                  ...
                  <div className={`timer-display ${todo.currentPhase}`}>
                    <span className="phase-label">
                      ...
                      {todo.isRunning && <span className="working-indicator"> {language === 'ja' ? '(作業中)' : '(Working)'}</span>}
                    </span>
